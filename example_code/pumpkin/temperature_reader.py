            ...
            if data[0].strip()[-3:] == "YES":
                ...
                if equals_pos != -1:
                    ...
                    if self.update and (abs(self.celcius, self.lastSentValue) > self.differenceToTriggerReport):
                        ...
                        report = send_data.SendData(send_data.SEND_REPORT, data=str(self.celcius), network_id=my_ids.NETWORK_ID, device_id=my_ids.TODO, service_id=my_ids.TODO, report_id=my_ids.TODO)
